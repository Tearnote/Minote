...
auto Sky::generateAtmosphereModel(AtmosphereParams const& atmosphere,
	vuk::PerThreadContext& ptc, glm::uvec2 resolution, glm::mat4 viewProjection) -> vuk::RenderGraph {

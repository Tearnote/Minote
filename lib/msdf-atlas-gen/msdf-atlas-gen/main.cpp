...
INPUT SPECIFICATION
  ...
  -charset <filename>
      Specifies the input character set. Refer to the documentation for format of charset specification. Defaults to first 256.
...
int main(int argc, const char * const *argv) {
    ...
    if (!(config.imageFilename || config.jsonFilename || config.csvFilename)) {
